...
<html lang="en">
  ...
  <head>
    <title>Productos de la Categoría Seleccionada | </title>
    <?php 
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Productos de <?= htmlspecialchars($category['name']) ?></li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Productos de <?= htmlspecialchars($category['name']) ?></h2>
                </div>
              </div>
            </div>
          </div>
